...
<div class="topnav">
    ...
    <a class="active" href="search.jsp">Search Books</a>
</div>
<div class="container-addForm">
    <form id="addForm" action="BookSearchServlet" method="get">
        <div class="row">
            <label>Name</label>
        ...
        <br>
        <div class="row">
            <button type="submit" class="btn" name="submit">Search Books</button>
        </div>
    </form>
</div>
</body>
